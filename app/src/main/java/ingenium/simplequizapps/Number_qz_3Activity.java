...
public class Number_qz_3Activity extends AppCompatActivity {

    TextView result;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_number_qz_3);
                    ...
                    Thread th=new Thread() {
                        ...
                        public void run() {
                            try {
                                ...
                                Intent intent = new Intent(Number_qz_3Activity.this, Numberqz_4Activity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                                startActivity(intent);
                                Number_qz_3Activity.this.finish();
                            } catch (Exception e) {
